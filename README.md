# Проект «Продуктовый помощник» - Foodgram ![Django-app workflow](https://github.com/bIackbuII/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)
...
git push
```
запускается набор блоков команд jobs (см. файл [foodgram_workflow.yml](https://github.com/needred/foodgram-project-react/blob/master/.github/workflows/backend.yml), т.к. команда `git push` является триггером workflow проекта.  
...
```
При необходимости наполните базу данными из backend/data/:
```
...
## Об авторе
[bIIackbuII](https://github.com/biackbuii/)
